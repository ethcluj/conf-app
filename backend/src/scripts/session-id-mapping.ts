...
function main() {
  try {
    ...
    console.log('Session Title | Fixed ID');
    console.log('------------- | --------');
    ...
    console.log('\nInstructions:');
    console.log('1. Add a new column J titled "Session ID" to your Google Sheet');
    console.log('2. For each session in the mapping, find the corresponding row in the sheet');
    console.log('3. Set the value in column J to the Fixed ID from the mapping');
    console.log('4. After updating the Google Sheet, restart the backend to apply the changes');
  } catch (error) {
